        ...
        <div className="homewrapper">
            ...
            <div className="pagewrapper">
                ...
                <div className='pt-[2rem]'>
                    ...
                    <AnimationOnScroll animateIn="animate__slideInUp" animateOnce={true} duration={1}>
                        <div className="servicebox h-[65vh] shadow-md shadow-gray-700  ease-in duration-200 hover:shadow-blue-500 hover:shadow-lg my-4 p-4 cursor-pointer rounded-xl bg-white rounded-xl py-[2rem]">
                            <div className="image">
